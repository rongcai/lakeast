...
public class CAL4ValueTaskTest {
	public static void main(String[] args) {
		try {
			new CAL4ValueTaskTest().go(args);
	...
	public void go(String[] args) throws InitializeException {
		...
		matrices[0] = new QuotedPriceMatrix(path + "L4_500.txt");
		matrices[1] = new QuotedPriceMatrix(path + "L4_1000.txt");
		matrices[2] = new QuotedPriceMatrix(path + "L4_1500.txt");
